...
using musc = Microsoft.UI.Xaml.Controls;

// The Templated Control item template is documented at https://go.microsoft.com/fwlink/?LinkId=234235

namespace SousChef.Extensions
{
    public sealed class SCNavigationViewItem : musc.NavigationViewItem
    {
        public SCNavigationViewItem()
        {
            this.DefaultStyleKey = typeof(SCNavigationViewItem);
        }
